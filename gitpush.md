...
curl -s https://api.github.com/repos/IroScript/audio-transcription-editor/commits/main | Select-String -Pattern '"sha"' | Select-Object -First 1
...
start https://github.com/IroScript/audio-transcription-editor
...
- **Repository:** https://github.com/IroScript/audio-transcription-editor
- **Default Branch:** main
